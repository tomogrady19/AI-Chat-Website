...
export function showLoggedIn() {
    ...
    document.getElementById("hero-subtitle").textContent = "You're logged in! Try changing the time range and playing some of your songs!";;
...
export function showLoggedOut() {
    ...
    const subtitleMessage = document.getElementById("hero-subtitle");
